...
int Disassembler::simpleInstruction(const std::string &instrName, const int offset) {
  std::print("{}\n", instrName);
  return offset + 1;
}

int Disassembler::constantInstruction(const std::string& instrName, const Chunk& chunk, const int offset) {
